...
gtk_box_pack_start(GTK_BOX(hbox_1), username_label, TRUE, FALSE, 5);
gtk_box_pack_start(GTK_BOX(hbox_1), username_entry, TRUE, FALSE, 5);

gtk_box_pack_start(GTK_BOX(hbox_2), password_label, TRUE, FALSE, 5);
gtk_box_pack_start(GTK_BOX(hbox_2), password_entry, TRUE, FALSE, 5);

gtk_box_pack_start(GTK_BOX(vbox), hbox_1, FALSE, FALSE, 5);
gtk_box_pack_start(GTK_BOX(vbox), hbox_2, FALSE, FALSE, 5);
